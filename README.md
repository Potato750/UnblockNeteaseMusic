...
```
$ npx @leepotato/unblockneteasemusic
```

或使用 Docker

```
$ docker run leepotato/unblockneteasemusic
```
...
```
$ npm install @leepotato/unblockneteasemusic
```

```javascript
const match = require('@leepotato/unblockneteasemusic')
